...
create memory table T_USER_BASE_FUNCTION ( UBF_ID_C varchar(36) not null, UBF_IDUSER_C varchar(36) not null, UBF_IDBASEFUNCTION_C varchar(20) not null, UBF_CREATEDATE_D datetime not null, UBF_DELETEDATE_D datetime, primary key (UBF_ID_C) );
